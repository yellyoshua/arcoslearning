          ...
          {scores
            ...
            .map((score, key) => {
              return (
                <tr key={key}>
                  <th scope="row">
                    <img src={score.user.avatar?.url} width="40" height="40" className="d-inline-block align-top mx-3" alt={'avatar-' + score.user.name} />
                  </th>
                  <td>{score.user.name}</td>
                  <td>{score.quiz}</td>
                  <td className="d-flex justify-content-center align-items-center">
                    <p>{score.qualification}/100</p>
                    <p className="text-white" style={{ padding: '0px 10px', borderRadius: '50%' }}>
                      {score.score}
                    </p>
                  </td>
                </tr>
